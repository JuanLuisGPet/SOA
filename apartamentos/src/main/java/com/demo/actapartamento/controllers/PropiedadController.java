...
import com.demo.actapartamento.services.PropiedadService;
...
public class PropiedadController {
    ...
    public List<PropiedadModel> getPropiedadesByTipo(@PathVariable TipoPropiedad tipo) {
        return propiedadService.getPropiedadesByTipo(tipo);
    }

    @GetMapping("/dueno/{id}")
    public List<PropiedadModel> getPropiedadesByPropietario(@PathVariable Long id) {
        return propiedadService.getPropiedadesByPropietario(id);
    }
}
